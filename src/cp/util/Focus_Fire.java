...
public class Focus_Fire {
    ...
    public static void onFocus_lostFocus2(final JTextField tf) {
        tf.addFocusListener(new FocusListener() {

            @Override
            public void focusGained(FocusEvent e) {
                tf.setBackground(new java.awt.Color(255, 255, 153));
            }
    ...
    public static void select_all2(final JTextField tf) {
        tf.addFocusListener(new FocusListener() {
